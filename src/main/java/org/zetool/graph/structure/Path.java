...
/**
 * The {@code Path} interface unites the common methods of paths in graphs. It can be implemented by static paths as
 * well as by dynamic paths.
 */
public interface Path extends Iterable<Edge> {
     ...
     * i.e. i.e. the endnode of the current last edge must be equal to the startnode of {@code edge}.
     *
     * @param edge the edge to insert at the end of the path
    ...
    /**
     * Returns all edges of this path. The returntype implements the interface {@link IdentifiableCollection}. The
     * interface specifies methods to address the content.
     *
    ...
    /**
     * Returns a String containing all edges. An edge e=(a,b) will be represented by (a,b) in the string.
     *

...
public class GraphUtil {
    ...
    /**
     * Computes a graph beteen two vertices in a directed graph, if there is such a path.
     *
     * @param g the graph
    ...
    public static Path getPath(Graph g, Node start, Node end) {
        // start a breadth first search from the start vertex until the end vertex is reached.
    ...
    /**
     * Creates a network equal to the network but all edges between a pair of nodes are reversed.
     *

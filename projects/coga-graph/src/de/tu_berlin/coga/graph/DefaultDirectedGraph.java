...
/**
 * An implementation of a directed graph that is able to hide arcs.
 * The {@code ModifiableGraph} provides an implementation of a directed graph
...
public class DefaultDirectedGraph implements DirectedGraph, ModifiableGraph {
	...
	/**
	 * Creates a new ModifiableGraph with the specified capacities for edges and nodes.
